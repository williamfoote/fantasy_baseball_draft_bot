---
title: "Cleaning Batting Projections 2025"
...
bsteamer <- read.csv("~/Documents/GitHub/fantasy_baseball_draft_bot/R-stuff/2025/data/batc_2025.csv")
# bdc <- read.csv("bat_dc.csv")
# bbat <- read.csv("bat_bat.csv")
# batc <- read.csv("bat_atc_23.csv")
id_map <- read.csv('id_map_2025.csv')
```
...
```{r}
espn <- read.csv("~/Documents/GitHub/fantasy_baseball_draft_bot/R-stuff/2025/data/espn_positions_2025.csv")
...
ggplot(join_3, aes(x = points, color = position, fill = position)) + 
  ...
  scale_color_brewer(palette = "Set1") +  # Set color palette
  scale_fill_brewer(palette = "Set1") +   # Ensure fill color matches line color
  facet_wrap(~position, scales = "fixed")  # Facet by position with fixed scales
