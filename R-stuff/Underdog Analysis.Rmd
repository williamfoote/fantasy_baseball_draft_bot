...
```{r}
results = read.csv('/Users/williamfoote/Documents/GitHub/fantasy_baseball_draft_bot/data/underdog_daily_data/results/4_13-early_results.csv')

player_names = str_replace(results$Team.1, pattern = " ", replacement = "-")
player_names = c(player_names, str_replace(results$Team.2, pattern = " ", replacement = "-"))
